...
FOR /F "delims=" %%i IN ('python dist/mdmtoolsap_bundle.py --program diff_print_expected_filename --cmp-scheme-left "%TEXTFILE_OLD_JSON%" --cmp-scheme-right "%TEXTFILE_RECENT_JSON%" ') DO SET "OUTPUT_FINAL_DIFF_JSON=%%i"
