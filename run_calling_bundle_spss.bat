...
IF %CONFIG_INCLUDE_VARIABLES_META% ( SET "SPSS_READ_CONFIG=!SPSS_READ_CONFIG! --config-read-variables yes" )
IF %CONFIG_INCLUDE_VALUELABELS_META% ( SET "SPSS_READ_CONFIG=!SPSS_READ_CONFIG! --config-read-value-labels yes" )
IF %CONFIG_INCLUDE_DATA% ( SET "SPSS_READ_CONFIG=!SPSS_READ_CONFIG! --config-read-data yes" )
