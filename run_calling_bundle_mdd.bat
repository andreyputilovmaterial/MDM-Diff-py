...
FOR /F "delims=" %%i IN ('python dist/mdmtoolsap_bundle.py --program diff_print_expected_filename --cmp-scheme-left "%MDD_A_JSON%" --cmp-scheme-right "%MDD_B_JSON%" ') DO SET "OUTPUT_FINAL_DIFF_JSON=%%i"
